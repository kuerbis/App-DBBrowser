            ...
            IN: while ( 1 ) {
                ...
                if ( $pattern_in =~ /$rx_locale_dependent/ ) {
                    ...
                    if ( length $locale_in ) {
                        ...
                        push @tmp_info, $prompt_locale_in . $locale_in;
                    }
                }
